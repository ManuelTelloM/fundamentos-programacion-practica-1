...
return comprobar = (edad <=17) ? "menor" : (edad >=65) ? "mayor" : "adulto";
}
...
function transponer(matriz) {
  ...
  return Array.from({length: matriz[0].length}, (_,indiceColumna) => matriz.map(fila => fila[indiceColumna]));
}
